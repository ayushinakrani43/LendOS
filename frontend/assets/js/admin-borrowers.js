...
//    const verified  = allBorrowers.filter(b => b.kyc_status === 'verified').length;
//    const submitted = allBorrowers.filter(b => b.kyc_status === 'submitted').length;
//    const pending   = allBorrowers.filter(b => b.kyc_status === 'pending').length;
...
//    document.getElementById('cnt-verified').textContent  = allBorrowers.filter(b => b.kyc_status === 'verified').length;
//    document.getElementById('cnt-submitted').textContent = allBorrowers.filter(b => b.kyc_status === 'submitted').length;
//    document.getElementById('cnt-pending').textContent   = allBorrowers.filter(b => b.kyc_status === 'pending').length;
//}
//
//// ── Tab switch ─────────────────────────────────────────────────
...
//        const matchTab =
//            currentTab === 'all'      ? true :
//            currentTab === 'verified' ? b.kyc_status === 'verified' :
//            currentTab === 'submitted'? b.kyc_status === 'submitted' :
//            currentTab === 'pending'  ? b.kyc_status === 'pending' :
//            currentTab === 'has-loan' ? ['active','disbursed','applied','approved'].includes(b.loan_status) :
//            currentTab === 'no-loan'  ? (!b.loan_status || b.loan_status === 'none') : true;
//
